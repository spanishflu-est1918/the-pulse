...
A PULSE is a story beat that advances the narrative—a new revelation, challenge, location change, or plot development.

NOT pulses (these don't count toward your ~20):
- Tangent responses (engaging with player jokes, digressions, banter)
...
You have ~20 pulses to tell the story. Everything else is free. A 50-turn session might only have 20 pulses—the other 30 turns are tangents, clarifications, and atmosphere. All valid. None count toward the 20.
...
The story guide is flexible. Pulse order can adapt, content can shift based on player choices. What matters: tangent responses don't burn your pulse budget.
